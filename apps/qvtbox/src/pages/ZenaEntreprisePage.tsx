  ...
  useEffect(() => {
    const loadCompany = async () => {
      ...
      const { data } = await supabase
        ...
        .limit(1)
        .maybeSingle();
      setCompanyId(data?.enterprise_id ?? null);
    };
        ...
        <section className="px-6 pb-16">
          <div className="container mx-auto max-w-5xl">
            <ZenaChatPanel
              sphere="company"
              companyId={companyId}
              title="Parler à ZÉNA côté entreprise"
              subtitle="ZÉNA collecte les signaux faibles et propose des actions concrètes pour protéger les équipes."
            />
          </div>
        </section>
