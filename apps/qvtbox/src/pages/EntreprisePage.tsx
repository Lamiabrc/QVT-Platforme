      ...
      <main>
        <section className="relative overflow-hidden px-6 pb-16 pt-32 md:pt-40">
          ...
          <div className="relative z-10 mx-auto max-w-5xl">
            ...
            <p className="mt-4 max-w-3xl text-base text-[#6F6454] md:text-lg">
              Check-in simple, signaux faibles, recommandations. RH/QVT voit des tendances agrégées,
              pas des secrets individuels.
            </p>
        ...
        <section id="comment-ca-marche" className="border-y border-[#E8DCC8] bg-[#FDF9F0] py-16 md:py-20">
          <div className="mx-auto grid max-w-6xl gap-6 px-6 md:grid-cols-3">
            {[
              "Check-in ‘ça va ?’ en 30 secondes",
              "Bulles d’équipe de confiance",
              "Dashboard RH agrégé et actionnable",
            ].map((title) => (
              <article
                key={title}
