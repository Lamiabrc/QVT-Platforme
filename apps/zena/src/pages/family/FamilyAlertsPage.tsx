...
const FamilyAlertsPage = () => {
  ...
  const handleSend = async () => {
    ...
    if (!familyId) {
      setLog((prev) => ["Activez une famille avant d'envoyer une alerte.", ...prev]);
      return;
    }
    ...
    setLog((prev) => [
      "Alerte envoyee a la tutelle familiale (notification en cours).",
      ...prev,
    ]);
    setMessage("");
  };
  ...
  return (
    <SphereLayout
      ...
      description="Declencher une alerte detresse ou harcelement. Visible par les guardians uniquement."
    >
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-border p-6 space-y-3">
          ...
          <p className="text-xs text-muted-foreground">
            Les alertes sont visibles par les guardians et la personne a l'origine de l'alerte.
          </p>
        </div>
      </div>
    </SphereLayout>
